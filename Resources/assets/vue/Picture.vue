    ...
    <div class="picture col-lg-3 col-md-4 col-sm-6 col-xs-12">
        <div class="card" :class="{'my-images' : remove}">
            ...
            <div class="card-body" v-if="!remove">
                <div v-if="authenticated == true" class="btn-group btn-group-justified" role="group" aria-label="Basic example">
                    <a href="#"
                       @click.prevent="rate(0)"
                       class="btn btn-default disliked"
                       :class="{'disabled' : disabled && rated.rating != 0, 'rated rated-this' : rated.rating == 0 && disabled}"
                       :disabled="disabled">
                    ...
                    <a href="#"
                       ...
                       :class="{'disabled' : disabled && rated.rating != 1, 'rated rated-this' : rated.rating == 1 && disabled}"
                       :disabled="disabled">
                    ...
                    <a href="#"
                       ...
                       :class="{'disabled' : disabled && rated.rating != 2, 'rated rated-this' : rated.rating == 2 && disabled}"
                       :disabled="disabled">
                    ...
                    <a href="#"
                       ...
                       :class="{'disabled' : disabled && rated.rating != 3, 'rated rated-this' : rated.rating == 3 && disabled}"
                       :disabled="disabled">
                        <i class="fa fa-star"></i> <br> {{ picture.stared }}
                    </a>
                </div>
                <div v-else class="btn-group btn-group-justified" role="group" aria-label="Basic example">
                    <a href="#"
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.disabled = this.authenticated == true ? this.picture.userID == this.uid || this.rated.rating : true;
